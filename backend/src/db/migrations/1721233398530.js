module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('companies', 'phones', { transaction });

      await queryInterface.removeColumn('companies', 'address', {
        transaction,
      });

      await queryInterface.removeColumn('companies', 'razonSocial', {
        transaction,
      });

      await queryInterface.removeColumn('companies', 'ruc', { transaction });
      ...
      await queryInterface.removeColumn('resources', 'published_at', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('resources', 'title', { transaction });
      ...
      await queryInterface.removeColumn('metrics', 'recorded_at', {
        transaction,
      });
