...
import { create } from '../../stores/resources/resourcesSlice';
...
ResourcesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_RESOURCES'}>
      {page}
    </LayoutAuthenticated>
  );
};
